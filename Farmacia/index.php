...
<body>
        <div class="container-md shadow pb-4">
            <h1 class="titulo text-center mt-5">Farmacia L.A</h1>
                        ...
                        <form action="ingresar_medicamento.php" method="POST">
                            ...
                            <label for="">Fecha de vencimiento</label>    
                                ...
                                <div class="modal-footer">
                                    <a class="btn btn-info me-4" href="http://localhost/PhP/farmacia/consultar_medicamentos.php" role="button">Consultar</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="ingresar_laboratorio.php" method="POST">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-info me-4" href="http://localhost/PhP/farmacia/consultar_laboratorio.php" role="button">Consultar</a>
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                <button type="submit" class="btn btn-primary">Guardar</button>
                            </div>
                        </form>
